...
echo.
echo %C_MAGENTA%============================================================
echo %C_MAGENTA%  JARVIS V20 - Developer Mode
echo %C_MAGENTA%============================================================
echo %C_RESET%

:: Debug information
echo %C_YELLOW%[DEBUG] Environment variables:%C_RESET%
echo   PROJECT_DIR=%PROJECT_DIR%
echo   SCRIPT_DIR=%SCRIPT_DIR%
echo   OLLAMA_URL=%OLLAMA_URL%
echo   GIT_REMOTE_URL=%GIT_REMOTE_URL%
echo.
echo %C_YELLOW%[DEBUG] Python path:%C_RESET%
where python 2>nul
echo.
echo %C_YELLOW%[DEBUG] All environment variables:%C_RESET%
set
echo.
...
if exist "%PROJECT_DIR%\.venv\Scripts\activate.bat" (
    ...
    echo %C_YELLOW%  [DEBUG] Python path after venv activation:%C_RESET%
    where python 2>nul
    echo %C_YELLOW%  [DEBUG] Python executable:%C_RESET%
    python -c "import sys; print(sys.executable)"
    echo %C_YELLOW%  [DEBUG] Python version:%C_RESET%
...
:: 6. Start JARVIS
echo %C_CYAN%============================================================
echo %C_CYAN%  Starting JARVIS V20 (DEBUG MODE)...
echo %C_CYAN%============================================================
echo %C_RESET%
echo.
